    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "specialist",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="organizations.specialist"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "service",
                    models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to="organizations.service"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "booking",
                    models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="organizations.booking"),
                ),
                (
                    "doctor",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="reviews", to="organizations.doctor"),
                ),
                (
                    "patient",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="reviews", to="organizations.patient"),
                ),
            ],
        ),
        migrations.AddIndex(
